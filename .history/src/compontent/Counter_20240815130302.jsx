...
import { decrement, reset } from '../Redux/counterSlice'
  ...
  return (
    <div style={{marginTop:'200px'}} className='d-flex justify-content-center align-items-center w-100  flex-column   '>
        ...
        <div className='mt-5'>
            ...
            <button onClick={()=>dispatch(reset())} className='btn btn-danger p-3 ms-3'>Decrement</button>
            <button onClick={()=>dispatch(inc)} className='btn btn-success p-3 ms-3'>Decrement</button>
