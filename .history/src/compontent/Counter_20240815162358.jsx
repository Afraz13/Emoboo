...
function Counter() {
  ...
  return (
    <div style={{marginTop:'200px'}} className='d-flex justify-content-center align-items-center w-100  flex-column   '>
        ...
        <div className='mt-5'>
            <button onClick={()=>dispatch(decrement(Number()))} className='btn btn-warning p-3'>Decrement</button>
        ...
        <div className='mt-5 w-100'>
          <input onChange={(e)=>setRange(e.target.value)} type="text" placeholder='Enter the range' className='form-control' style={{borderColor:'blue'}} />
        </div>
        </div>
